...
سرور ها یه رنج عظیمی از ipv6 به شما می دهند که با این قابلیت می تونید هر کانکشن جدید به یه دونه از این رنج به صورت رندوم متصل بشه که اینجوری فایروال همش ایپی های متفاوت میبینه. و سرور های هتزنر مثلا رنج 64 می دهند که یعنی ۲ به توان 64 عدد ایپی داریم برای اتصال که یعنی 18446744073709551615 عدد ایپی 
...
<p dir="rtl">
سپس در سرور خارج اینجوری اجرا می کنم
</p>
...
<p dir="rtl">
کانفیگ ریلیتی مستقیم با ماکس هالف داپلکس و  ترکیب این روش میشه این:
</p>
